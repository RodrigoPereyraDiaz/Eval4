Imports Eval3.DemoVb

Public Class Form1
    Inherits System.Windows.Forms.Form
    Implements iEvalFunctions
    ...
    Public Sub New()
        ...
        A = New Eval3.EvalVariable("A", 0.0, "UpDown A", GetType(Double))
        B = New Eval3.EvalVariable("B", 0.0, "UpDown B", GetType(Double))
        C = New Eval3.EvalVariable("C", 0.0, "UpDown C", GetType(Double))
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'cbSamples
        '
        Me.cbSamples.Items.AddRange(New Object() {"123+345", "(2+3)*(4-2)", "120+5%", "now", "Round(now - Date(2006,1,1))+"" days since new year""", "anumber*5", "arr(1)+arr(2)", "theForm.Controls(0).name", "theForm.Left"})
...
#End Region
    ...
    Public Function InheritedFunctions() As iEvalFunctions Implements iEvalFunctions.InheritedFunctions
        Return Nothing
    End Function
    ...
    'Public Event ValueChanged(ByVal Sender As Object, ByVal e As System.EventArgs) Implements Eval3.iEvalTypedValue.ValueChanged
    ...
    Public Class class2
        ...
        Public Function GetVariable(ByVal varname As String) As Eval3.iEvalTypedValue Implements Eval3.iVariableBag.GetVariable
            Select Case varname
                Case "dyn1"
                    Return New Eval3.EvalVariable("dyn1", 1.1, "Not used yet", GetType(Double))
            End Select
        End Function
    End Class
